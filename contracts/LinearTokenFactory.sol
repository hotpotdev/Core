...
contract LinearHotpotTokenFactory is LinearMixedHotpotToken{
    ...
    constructor(string memory name, string memory symbol, address treasury,uint mintRate,uint burnRate,address platform) LinearMixedHotpotToken(name,symbol,treasury,mintRate,burnRate,platform,100,1e16){
